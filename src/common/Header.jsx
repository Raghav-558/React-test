    ...
    <section className='bg-dark-blue '>
      <div className='pl-3.5 max-md:hidden bg-deep-blue' >
        <div className='flex items-center justify-between max-w-[1215px] mx-auto'>
          <img
            className='max-w-[115px] max-h-6 max-md:max-w-20 cursor-pointer'
            src='./assets/images/webp/tdk-logo.webp'
            alt='logo'
          />
          <img
            className='max-w-[427px] cursor-pointer'
            src='./assets/images/webp/language.webp'
            alt='logo'
          />
        </div>
      </div>
        ...
        <div className='flex items-center justify-between pt-11 pb-[22px]'>
          ...
          <form className='border border-white rounded-[5px] max-w-[257px] flex items-center justify-between overflow-hidden max-md:hidden pr-3 py-2'>
            <input
              ...
              className='text-white text-[13px] leading-[15px] pl-[14px] outline-none bg-transparent !placeholder-white'
            />
              <SearchIcon />
          </form>
          ...
          >
            <ul className='flex items-center flex-col gap-6'>
              ...
              <form className='max-w-[257px] border border-white rounded-[5px] flex items-center justify-between overflow-hidden pr-3 py-2'onClick={() => setOpen(false)} >
                <input
                  type='text'
                  name='search'
                  id='search'
